...
public class Sound {
	...
	/**
	 * generate an array that represents a "pure" tone of the specified frequency,
	...
	/**
	 * return the number of samples (array elements) for the given duration, based
	 * on the standard sampling frequency
	 */
	...
	/**
	 * return the duration (in seconds) of a sound clip, given the number of samples
	 * in the clip
	 */
